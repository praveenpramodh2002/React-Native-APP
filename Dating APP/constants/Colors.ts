...
export const pinkPrimary = "#FF69B4";
export const pinkSecondary = "#FFB6C1";
export const pinkAccent = "#FF1493";
export const pinkLight = "#FFC0CB";

export const borderColor = "#FFB6C180";
